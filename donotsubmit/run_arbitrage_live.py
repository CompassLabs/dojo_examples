...
def main():
    ...
    start_time = dateparser.parse("2025-06-21 09:00:00 UTC")
    end_time = dateparser.parse("2025-06-23 22:00:00 UTC")
    ...
    _, _ = live_run(env, [arb_policy], dashboard_port=8051, auto_close=True)
    # SNIPPET 1 END
